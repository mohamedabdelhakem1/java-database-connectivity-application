...
public class MyResultset implements ResultSet {
	...
	// cursor = 0 before first row
	// cursor = -1 last row
	// cursor = -2 after after last
	/*
	 * row - the number of the row to which the cursor should move. A value of zero
	 * indicates that the cursor will be positioned before the first row; a positive
	 ...
	 * result set. Calling absolute(1) is the same as calling first(). Calling
	...
	public MyResultset(ResultSetMetaData data, Object[][] table, String[] columns, Statement statement) {
		...
		for (int i = 0; i < columns.length; i++) {
			this.columns.put(columns[i], i + 1);
		}
	}
	...
	public int getInt(int arg0) throws SQLException {
		...
		try {
			int value = Integer.valueOf(String.valueOf(table[Cursor - 1][arg0 - 1]));
			return value;
		} catch (Exception e) {
			return 0;
		}
	...
	public int getInt(String arg0) throws SQLException {
		...
		try {
			int value = Integer.valueOf(String.valueOf(table[Cursor - 1][arg - 1]));
			return value;
		} catch (Exception e) {
			return 0;
		}
	...
	public String getString(int arg0) throws SQLException {
		...
		try {
			...
			return String.valueOf(table[Cursor - 1][arg0 - 1]);
		} catch (Exception e) {
			return null;
		}
	...
	public String getString(String arg0) throws SQLException {
		...
		try {
			...
			return String.valueOf(table[Cursor - 1][arg - 1]);
		} catch (Exception e) {
			return null;
		}
